...
resource "aws_subnet" "public_subnet_az1" {
  ...
  availability_zone       = data.aws_availability_zones.available_zones.names[0] # indexing
...
resource "aws_subnet" "public_subnet_az2" {
  ...
  availability_zone       = data.aws_availability_zones.available_zones.names[1] # indexing
  map_public_ip_on_launch = true
